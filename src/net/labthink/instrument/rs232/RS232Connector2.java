 ...
 *
 */
public class RS232Connector2 {
    // 使用单例模式创建

    private static RS232Connector2 rs232connector = null;
    ...
    /**
     * 单例模式获取RS232Connector2
     * 
     * @param receiverHandler
     * @return
     */
    public static synchronized RS232Connector2 getInstance(
            IoHandlerAdapter receiverHandler) {
        if (rs232connector == null) {
            rs232connector = new RS232Connector2(receiverHandler);
        }
    ...
    public static synchronized RS232Connector2 getInstance(
        ...
        if (rs232connector == null) {
            rs232connector = new RS232Connector2(receiverHandler, portAddress);
        }
        return rs232connector;
    }

    public static synchronized RS232Connector2 newInstance(
            IoHandlerAdapter receiverHandler, SerialAddress portAddress) {
        if (rs232connector != null) {
    ...
    private RS232Connector2() {
    }

    private RS232Connector2(IoHandlerAdapter receiverHandler) {
...
//            return;
    ...
    public static void main(String[] args) {
        ...
        RS232Connector2 receiver = new RS232Connector2(handler, portAddress);
