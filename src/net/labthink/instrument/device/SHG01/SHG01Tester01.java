package net.labthink.instrument.device.SHG01;

import net.labthink.instrument.device.SHG01.codec.SHG01ProtocolCodecFactory;
import net.labthink.instrument.device.SHG01.handler.SHG01Handler;
...
public class SHG01Tester01 implements Runnable {

    RS232Connector rs232connector;
    private static final String STORE_FILE = "save.dat";
    public SHG01Tester01(RS232Connector rs232connector) {
    ...
    public void sendSample() throws InterruptedException {
        ...
        SHG01OutMessage pkt = new SHG01OutMessage();
        WriteFuture wf;
    ...
    public static void main(String[] args) {
        ...
        SerialAddress portAddress = new SerialAddress("COM1", 9600,
                ...
                FlowControl.NONE);
        SHG01Handler handler = new SHG01Handler();
        handler.loadData();
        ...
        receiver.addFilter("codec", new ProtocolCodecFilter(
                new SHG01ProtocolCodecFactory())); // 设置编码过滤器
        // receiver.addFilter("codec", new ProtocolCodecFilter(
        // new TextLineCodecFactory(Charset.forName("UTF-8")))); // 设置编码过滤器
        receiver.startListen();
        SHG01Tester01 test = new SHG01Tester01(receiver);
