package net.labthink.instrument.device.SHG01.handler;
...
import net.labthink.instrument.device.SHG01.simulator.SHG01;
 ...
 * @author         Moses
 */
public class SHG01Handler extends IoHandlerAdapter {
    ...
    /* 仪器 */
    private SHG01 device = new SHG01();
...
//      System.out.println((a & 0x04) == 0x04);
    ...
    public void messageReceived(IoSession session, Object message) throws Exception {
        SHG01InMessage msg = (SHG01InMessage) message;
        byte[] incontent = msg.getContent();
        SHG01OutMessage outmsg = new SHG01OutMessage();
...
//          14H 功耗清零
        ...
        // SHG01InMessage pkt = new SHG01InMessage();
        //
...
//              System.arraycopy(k, 0, outmsgcontent, 6, 4);
     ...
     */
    public void setDevice(SHG01 device) {
        this.device = device;
    }
    ...
    public void saveData() {
        try {
            ...
            Logger.getLogger(SHG01Handler.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
