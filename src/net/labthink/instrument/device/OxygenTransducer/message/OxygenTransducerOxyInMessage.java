 ...
 * @author         Moses
 */
public class OxygenTransducerOxyInMessage extends AbstractPacket implements OxygenTransducerOxyInMessageParams {

    public OxygenTransducerOxyInMessage() {
    }

    public OxygenTransducerOxyInMessage(byte[] _content) {
    }
