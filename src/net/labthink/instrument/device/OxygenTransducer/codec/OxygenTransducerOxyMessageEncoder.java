 ...
 * @author         Moses
 */
public class OxygenTransducerOxyMessageEncoder<T extends OxygenTransducerOxyOutMessage> extends AbstractPacketEncoder<T> {

    /**
     * 
     */
    public OxygenTransducerOxyMessageEncoder() {
