package net.labthink.instrument.device.w3030.message;

import net.labthink.instrument.device.base.message.AbstractPacket;


public class W3030Message extends AbstractPacket implements W3030MessageParams{


	/**
	 * 
	 */
	private static final long serialVersionUID = -4126632049381346301L;

	public W3030Message() {
	reset();
    }

    public W3030Message(byte[] _content) {
