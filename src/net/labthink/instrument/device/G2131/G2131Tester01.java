package net.labthink.instrument.device.G2131;
...
public class G2131Tester01 implements Runnable {

    RS232Connector rs232connector;
    private static final String STORE_FILE = "save.dat";
    public G2131Tester01(RS232Connector rs232connector) {
    ...
    public void sendSample() throws InterruptedException {
        ...
        G2131OutMessage pkt = new G2131OutMessage();
        WriteFuture wf;
    ...
    public static void main(String[] args) {
        ...
        SerialAddress portAddress = new SerialAddress("COM1", 9600,
                ...
                FlowControl.NONE);
        G2131Handler handler = new G2131Handler();
        handler.loadData();
        ...
        receiver.addFilter("codec", new ProtocolCodecFilter(
                new G2131ProtocolCodecFactory())); // 设置编码过滤器
        // receiver.addFilter("codec", new ProtocolCodecFilter(
        // new TextLineCodecFactory(Charset.forName("UTF-8")))); // 设置编码过滤器
        receiver.startListen();
        G2131Tester01 test = new G2131Tester01(receiver);
