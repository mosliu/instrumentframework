 ...
 * @author Moses
 */
public class G2131 implements Serializable {
     ...
     * 实验腔*3
     */
    private G2131Cell[] cells = new G2131Cell[3];
    private G2131Cell   cell3 = new G2131Cell(this);
    private G2131Cell   cell2 = new G2131Cell(this);
    private G2131Cell   cell1 = new G2131Cell(this);
...
//      System.out.println(BytePlus.bytesToHexString(a));
     ...
     * @return 返回腔对象
     */
    public G2131Cell getCell(int i) {
	return cells[i - 1];
    }
