package net.labthink.instrument.device.W3060.handler;
...
public class W3060Handler extends IoHandlerAdapter {
	...
	public void messageReceived(IoSession session, Object message)
			throws Exception {
		W3060Message msg = (W3060Message) message;
		byte[] incontent = msg.getContent();
		W3060OutMessage outmsg = new W3060OutMessage();
		...
		System.out.println();
		// W3060Message pkt = new W3060Message();
		//	
