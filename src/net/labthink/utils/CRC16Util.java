...
//    private int gPloy = 0xC1C0; // 生成多项式
...
//        for (int i = 0; i < 256; i++) {
//            System.out.println(BytePlus.byteArray2String(BytePlus.short2bytes(crcTable[i])));
//        }
//        System.out.println("=========================================");
    }
     ...
     * 获取crc校验的byte形式
     */
    public byte[] crc16Bytes(byte[] data) {
        return BytePlus.short2bytes(crc16Short(data));
    }
    /*
     * 获取crc校验的short形式
     */

    public short crc16Short(byte[] data) {
        return getCrc(data);
    }

    //另一个方法
    public static final String getCRC16_M0(byte[] data) {
        int crc = 0xFFFF;
//        int crc = 0x0000;
...
//                    crc = (crc << 1) ^ 0x1021;
    ...
    //再一个方法
    public static String getCRC16_M1(byte[] b) {
 ...
 //再一个方法222
    public static String getCRC32_M1(byte[] b) {
        CRC32 crc32 = new CRC32();
        crc32.update(b);
        return Long.toHexString(crc32.getValue());
    }
    //再再一个办法
    public static String getCRC16_M2(byte[] bytes) {
        int[] table = {
        ...
        int crc = 0xFFFF;//之前错了，谢谢各位兄台的提示,在这里给予改正
        for (byte b : bytes) {
    ...
    //再再再一个办法
    public static String getCRC16_M3(byte[] data) {
        int CRCTABLE[] = {
    ...
    public static void main(String[] args) {
        ...
        byte[] crc = crc16.crc16Bytes(test);
        ...
        System.out.println(crc16.crc16Short(testc));
        
        
        byte[] test2 = new byte[]{2, 1, 0, 0, 0,0x0c};
        byte[] test22 = new byte[]{0x0c,0,0,0,1,2};
        byte[] test3 = new byte[]{0, 1, 2, 3, 4,54,54,34,5,35,34,1,34,1,2,3};
        System.out.println(BytePlus.byteArray2String(crc16.crc16Bytes(test2)));
        System.out.println("M0:"+getCRC16_M0(test2));
        System.out.println("M1:"+getCRC16_M1(test2));
        System.out.println("M2:"+getCRC16_M2(test2));
        System.out.println("M3:"+getCRC16_M3(test2));
        
        System.out.println("================================");
        
        System.out.println(BytePlus.byteArray2String(crc16.crc16Bytes(test22)));
        System.out.println("M0:"+getCRC16_M0(test22));
        System.out.println("M1:"+getCRC16_M1(test22));
        System.out.println("M2:"+getCRC16_M2(test22));
        System.out.println("M3:"+getCRC16_M3(test22));
    }
}
