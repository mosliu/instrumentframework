 ...
 */
package net.labthink.utils.other;
...
public class ResourceManager {
    ...
    public static void main(String[] args) {
        String a = ResourceManager.class.getClassLoader().getResource("net.labthink.tools.unitconvert").toString();
    ...
    /**
     * Attempts to find a resource in the classpath and returns an InputStream
     * to that resrouce
     *
    ...
    public static Properties loadProperties(InputStream Istream) throws java.io.IOException {
        ...
        synchronized (ResourceManager.class) {
            try {
                ...
                System.out.println("Can't load properties for Input stream");
                throw e;
            }
        }
        return props;
